...
const val KAFKA_CONSUMER_SYKETILFELLEBIT_KORRIGERER_UPDATED = "${KAFKA_CONSUMER_SYKETILFELLEBIT_BASE}_korrigerer_updated"
...
val COUNT_KAFKA_CONSUMER_SYKETILFELLEBIT_DUPLICATE: Counter = Counter.builder(KAFKA_CONSUMER_SYKETILFELLEBIT_DUPLICATE)
    ...
    .register(METRICS_REGISTRY)
val COUNT_KAFKA_CONSUMER_SYKETILFELLEBIT_KORRIGERER_UPDATED: Counter = Counter.builder(KAFKA_CONSUMER_SYKETILFELLEBIT_KORRIGERER_UPDATED)
    .description("Counts the number of korrigerer-update received from topic - syketilfellebit")
    .register(METRICS_REGISTRY)
